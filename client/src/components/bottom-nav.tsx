      ...
      <nav className="fixed bottom-4 left-3 right-3 aa-overlay-content backdrop-blur-lg border border-white/30 rounded-2xl shadow-lg">
        <div className="flex justify-around py-3 px-2">
          ...
          <button
            ...
            className="flex flex-col items-center py-2 px-3 rounded-xl nav-transition flex-1 bg-gradient-to-r from-[#CEE4D2] to-[#EF7326] hover:from-[#B8D4BE] hover:to-[#E5631A] text-gray-800 hover:scale-102 shadow-md"
          >
